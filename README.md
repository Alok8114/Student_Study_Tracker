...
Run main.py (e.g., python main.py) to start the program.
At the start menu, choose to Register, Login, or Exit.
After login, add sessions or view your study report.
